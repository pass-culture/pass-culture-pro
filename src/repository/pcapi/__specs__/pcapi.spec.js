...
describe('pcapi', () => {
  ...
  describe('loadFilteredOffers', () => {
    ...
    it('should call offers route with filters when provided', async () => {
      // Given
      const statusFilters = { active: false, inactive: false, soldOut: false, expired: false }
      ...
      expect(client.get).toHaveBeenCalledWith(
        '/offers?name=OCS&venueId=AA&page=2&active=false&inactive=false&sold-out=false&expired=false'
      )
    })
